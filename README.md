...
Reset refuses while the exact project session exists. Tmuxinator does not reconcile config changes into a live session, and ending a session terminates every process in its panes.
