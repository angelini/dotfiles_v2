...
def test_report_constants_pin_selected_commands_applications_and_mapping() -> None:
    ...
    assert CONFIG_FILES == (
        ...
        ("config/zed-host-bridge/bridge.mjs", ".local/libexec/dotgen/zed-host-bridge.mjs", "exact"),
        ("config/zed-host-bridge/serve", ".local/libexec/dotgen/zed-host-bridge-serve", "exact"),
        ("config/zed-host-bridge/config.json.template", ".config/dotgen/zed-host-bridge.json", "manual"),
        ("config/zed-host-bridge/dev.dotgen.zed-host-bridge.plist", "Library/LaunchAgents/dev.dotgen.zed-host-bridge.plist", "exact"),
        ("config/zed-host-bridge/ssh.conf.template", ".ssh/config.d/dotgen-zed-host-bridge.conf", "manual"),
